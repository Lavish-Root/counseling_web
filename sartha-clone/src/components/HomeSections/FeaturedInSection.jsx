        ...
        <section className="py-10 border-t border-gray-100">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
                    <div className="flex w-[200%] animate-scroll hover:[animation-play-state:paused] active:[animation-play-state:paused]">
                        {/* First Set of Logos */}
                        <div className="flex w-1/2 justify-around items-center gap-8 md:gap-16 opacity-80 grayscale hover:grayscale-0 active:grayscale-0 transition-all duration-500">

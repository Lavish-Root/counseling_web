...
const Footer = () => {
    return (
        <footer className="bg-dark-bg text-white pt-16 pb-8 border-t border-gray-800">
            ...
            <a href="https://wa.me/7203086849" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:scale-110 transition z-50">
                <FaWhatsapp size={24} />
            </a>
        </footer>
    );
